...
SECURITY LABEL FOR anon ON ROLE cientifico IS 'MASKED';
...
SECURITY LABEL FOR anon ON COLUMN diagnostico.id_diagnostico IS 'MASKED WITH VALUE ''0'' ';
SECURITY LABEL FOR anon ON COLUMN diagnostico.id_patologia IS 'MASKED WITH VALUE ''0'' ';