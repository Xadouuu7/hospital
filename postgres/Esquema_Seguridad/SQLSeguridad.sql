...
GRANT SELECT ON view_enfermeros TO recursos_humanos;
GRANT SELECT ON view_farmaceuticos TO recursos_humanos;
GRANT SELECT ON view_informaticos TO recursos_humanos;
GRANT SELECT ON view_recursos_humanos TO recursos_humanos;
GRANT SELECT ON view_cientificos TO recursos_humanos;
